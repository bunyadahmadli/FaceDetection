...
class FaceDetect(QDialog):
    ...
    def start_webcam(self):
        self.capture=cv2.VideoCapture(1) #0 =default #1,2,3 =Extra Webcam
    ...
    def detect_face(self,img):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.putText(img, 'Bunyad', (x,y),cv2.FONT_HERSHEY_SIMPLEX ,1 ,(255, 0, 0), 2 ,cv2.LINE_AA) 
...
if __name__=='__main__':
    ...
    window=FaceDetect()
    window.setWindowTitle('Opencv and Pyqt5 Face Detection')
    window.show()
    sys.exit(app.exec_())